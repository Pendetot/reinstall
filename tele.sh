...
if [ "$#" -ne 2 ]; then
  ...
  echo " win_10, win_22, win_19, win_12"
...
if [[ "$IMG_VERSION" =~ ^https?://.*\.gz.*$ ]]; then
  ...
  case $IMG_VERSION in
    win_10ghost)
      IMG_URL="https://naga.virtahost.com/image/win10ghost.gz"
      ;;
    win_22)
      IMG_URL="https://naga.virtahost.com/image/windows2022.gz"
      ;;
    win_19)
      IMG_URL="https://naga.virtahost.com/image/win2019.gz"
      ;;
    # Standard Versions
    win_2008)
